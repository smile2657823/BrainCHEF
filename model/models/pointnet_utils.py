...
class STN3d(nn.Module):
    def __init__(self, channel):
        ...
        self.fc1 = nn.Linear(1024, 512, dtype=torch.float)
        self.fc2 = nn.Linear(512, 256, dtype=torch.float)
        self.fc3 = nn.Linear(256, 9, dtype=torch.float)
        self.relu = nn.ReLU()
...
class PointNet(nn.Module):
    def __init__(self, k=40,channel=5 ):
...
class TopologicalFeatureNetwork(nn.Module):
    def __init__(self, channels, hidden_size):
        super(TopologicalFeatureNetwork, self).__init__()
        self.fc1 = nn.Linear(channels, 16)  
